    ...
    <a.group ref={gymRef}>
      <group name="Scene">
        ...
        <mesh
          ...
          rotation={[Math.PI / 2, 0, 0]}>
          <group name="Left_door" position={[5.065, 0.115, 0]} ref={leftDoorRef}>
            <mesh
              name="gym_model_138"
          ...
          <group name="Right_door" position={[0.717, 0.115, 0]}ref={rightDoorRef}>
            <mesh
              name="gym_model_137"
        ...
        />
        <group
          name="barbell_w_weight" //barbell for game
